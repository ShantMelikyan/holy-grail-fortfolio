...
const Footer = () => {
  return (
    <footer className="w-full h-20 px-4 pb-4">
      <div className="flex items-center justify-between w-full h-full max-w-3xl text-center m-auto p-6 rounded-full dark:bg-[#645d65a1] backdrop-filter backdrop-blur-md shadow-md border border-[#645d6525]">
